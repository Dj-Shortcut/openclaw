...
export const messengerSetupAdapter: ChannelSetupAdapter = {
  ...
  validateInput: createSetupInputPresenceValidator({
    defaultAccountOnlyEnvError:
      "MESSENGER_* env vars can only be used for the default Messenger account.",
    whenNotUseEnv: [
      {
        someOf: ["pageId"],
        message: "Messenger requires pageId (or --use-env).",
      },
      {
      ...
      },
      {
        ...
        message: "Messenger requires appSecret or --app-secret-file (or --use-env).",
      },
      {
        someOf: ["verifyToken", "verifyTokenFile"],
        message: "Messenger requires verifyToken or --verify-token-file (or --use-env).",
      },
    ],
  }),
